...
class ListmusicController extends BaseController {
    ...
    public function postNew(){
        ...
        if (!empty($_POST)) {
            ...
            $validator->add('genero:Os Type', 'required', [], $requiredFieldMessageError);
            $validator->add('anio:Based On', 'required',[], $requiredFieldMessageError);
            $validator->add('origin:Origen','required',[],$requiredFieldMessageError);
            $validator->add('creado:Arquitectura','required',[],$requiredFieldMessageError);
            $validator->add('duracion:Duracion','required',[],$requiredFieldMessageError);
            $validator->add('lugarencontrado:Categoría','required',[],$requiredFieldMessageError);
            ...
            $listmusic['errorTracker'] = htmlspecialchars(trim($_POST['errorTracker']));
    ...
    public function putEdit($id){
        ...
        if( !empty($_POST)){
            ...
            $listmusic['valoracion'] = htmlspecialchars(trim($_POST['forum']));
            $listmusic['youtube'] = htmlspecialchars(trim($_POST['youtube']));
            $listmusic['link'] = htmlspecialchars(trim($_POST['errorTracker']));
            $listmusic['description'] = htmlspecialchars(trim($_POST['description']));
